...
export const metadata: Metadata = {
  ...
  description:
    "Submit your research papers to ICAIES³ 2026 across 6 tracks: Intelligent Systems, Secure Computing, HPC, Networking, IoT, and Emerging Technologies.",
};
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-[1280px] px-6 lg:px-12 py-10 lg:py-14">
        <PageTitle
          lightText="Call for"
          accentText="Papers"
          description="We invite researchers, academicians, and industry professionals to submit original research papers across the following tracks."
        />
