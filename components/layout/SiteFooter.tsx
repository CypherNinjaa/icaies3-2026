        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              The premier forum for AI, Security & Scalable Systems.
              Organized by {siteMeta.organizer},{" "}
              {siteMeta.university}.
            </p>
            <div className="flex items-center gap-2 text-sm text-gray-400">
              <MapPin className="w-4 h-4 text-accent flex-shrink-0" />
              <span>{contactInfo.address.line2}, {contactInfo.address.line3}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: "Submit Paper", href: "https://cmt3.research.microsoft.com/", external: true },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
