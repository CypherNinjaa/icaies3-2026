	...
	return (
		<div className="rounded-2xl border border-accent/15 bg-linear-to-br from-accent/10 via-white to-bg-cream p-5 shadow-sm">
			...
			<a
				...
				target="_blank"
				rel="noreferrer"
				className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-accent px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent-dark focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
			>
				Submit via CMT
